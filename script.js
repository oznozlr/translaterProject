    ...
    icon.addEventListener("click", (element) =>{
        if(element.target.classList.contains("fa-copy")){
            ...
            if(element.target.id == "from" ){
                ...
                uttrerance = new SpeechSynthesisUtterance(fromText.value);
                uttrerance.lang = fromLang.value;

            }else{
                uttrerance = new SpeechSynthesisUtterance(toText.value);
                uttrerance.lang = toLang.value;
